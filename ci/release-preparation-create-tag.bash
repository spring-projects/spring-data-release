...
if test -f application-local.properties; then
    ...
    function spring-data-release-shell {
        java \
            ...
            --cmdfile target/release-preparation-create-tag.shell
    }
else
...
sed "s|\${VERSION}|${VERSION}|g" < ci/release-preparation-create-tag.template > target/release-preparation-create-tag.shell
